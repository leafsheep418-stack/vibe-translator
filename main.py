...
STYLE_PROMPTS = {
    "discord": (
        "将用户选中的英文翻译成自然的中文，风格适合 Discord 日常聊天。"
        "语气要轻松、自然、像真人聊天。可以保留或少量使用常见英文缩写，"
        "例如 brb、btw、idk、tbh，但不要过度。"
        "必须原样保留 emoji、链接、@用户名和代码片段。"
    ),
    "academic": (
        "将用户选中的英文翻译成正式、严谨的中文，风格适合论文或学术写作。"
        "用词要准确、客观，避免口语化表达。"
        "必须原样保留 emoji、链接、@用户名和代码片段。"
    ),
    "business": (
        "将用户选中的英文翻译成礼貌、清晰、专业的中文，风格适合商务邮件。"
        "语气要尊重、简洁、得体。"
        "必须原样保留 emoji、链接、@用户名和代码片段。"
    ),
}
